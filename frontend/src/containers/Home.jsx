...
const Home = () => {
  return (
    <div className="min-h-screen w-full flex justify-center items-center flex-col px-2 overflow-hidden">
        ...
        <div className="relative" id="card">
          ...
          <div className="max-w-xs sm:max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 mx-auto md:mx-0">
            ...
            <div className="p-4 sm:p-5">
              ...
              <Link
                to="/sign-up"
                className="relative flex w-28 sm:w-32 h-10 sm:h-12 items-center justify-center border border-zinc-700 rounded-lg bg-primary hover:bg-secondary hover:text-primary text-slate-300 font-bold"
              >
